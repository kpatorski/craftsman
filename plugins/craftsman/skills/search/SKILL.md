...
name: search
description: >
  Answers "do we already have something about X?" — searches both `~/.claude/craftsman/directives/index.md` and `protocols/index.md` by id, title and description, and returns candidates with links and enabled/disabled status. Trigger: "/craftsman:search", "do we have a directive for...", "is there already a protocol that...", "check before I write a new one".
argument-hint: "<topic>"
